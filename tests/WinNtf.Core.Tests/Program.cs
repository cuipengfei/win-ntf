...
public static class Program
{
    public static async Task<int> Main()
    {
        var tests = new (string Name, Func<Task> Run)[]
        {
            ...
            (nameof(NotificationSlotQueueTests.AcquireDroppingOldestReusesEarliestSlotWhenFull), Sync(NotificationSlotQueueTests.AcquireDroppingOldestReusesEarliestSlotWhenFull)),
            (nameof(NotificationSlotQueueTests.ReleaseIgnoresStaleDroppedLease), Sync(NotificationSlotQueueTests.ReleaseIgnoresStaleDroppedLease)),
            (nameof(NotificationSlotQueueTests.BumpToNewestPreventsSlotFromBeingDroppedNext), Sync(NotificationSlotQueueTests.BumpToNewestPreventsSlotFromBeingDroppedNext)),
            (nameof(NotificationSlotQueueTests.BumpToNewestReturnsFalseForInactiveSlot), Sync(NotificationSlotQueueTests.BumpToNewestReturnsFalseForInactiveSlot)),
            (nameof(NotificationDisplayKeyTests.FromTreatsSameVisibleNotificationAsDuplicate), Sync(NotificationDisplayKeyTests.FromTreatsSameVisibleNotificationAsDuplicate)),
            (nameof(NotificationDisplayKeyTests.FromKeepsDifferentVisibleNotificationSeparate), Sync(NotificationDisplayKeyTests.FromKeepsDifferentVisibleNotificationSeparate)),
            ...
            (nameof(AppConfigStoreTests.LoadOrCreateRejectsInvalidMaxVisible), Sync(AppConfigStoreTests.LoadOrCreateRejectsInvalidMaxVisible)),
